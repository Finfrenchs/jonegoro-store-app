...
import 'package:jonegoro_store_app/pages/auth/widgets/sign_up_widget.dart';

import 'package:jonegoro_store_app/utils/custom_themes.dart';
import 'package:jonegoro_store_app/utils/dimensions.dart';
import 'package:jonegoro_store_app/utils/images.dart';
...
class _AuthPageState extends State<AuthPage> {
  ...
  Widget build(BuildContext context) {
    //use pagecontroller for switch page signin or signup
